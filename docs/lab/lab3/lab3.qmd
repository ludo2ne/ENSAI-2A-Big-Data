...
- [Notebook](base_notebook_lab3.ipynb){target="_blank"}
...
## 1. Spark cluster creation in AWS

:warning: **DO NOT FORGET TO TURN YOUR CLUSTER OFF A THE END OF THIS TUTORIAL!**
...
## 5. The basics of Spark's Structured Streaming 
...
### ✍ Event-time processing :hourglass:
...
#### ✍ Handling late data with watermarks :hourglass_flowing_sand:
