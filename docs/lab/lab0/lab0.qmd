...
- [AWS Login](https://www.awsacademy.com/vforcesite/LMS_Login){.external target="_blank"}
- Dashboard
...
- [ ] Click on `Charger`, and upload the file [Lab0_files.zip](lab0_files.zip)
...
- [ ] A terminal will open with  `login as:`. Type `ec2-user` then press `Enter`([documentation officielle](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/connection-prereqs.html){.external target="_blank"})
...
- [ ] For security reasons, you cannot execute your files. Do `chmod 764 get_data.sh awk.sh GetMaxTempC` to change that. For more details, the [chmod wikipedia page](https://fr.wikipedia.org/wiki/Chmod){.external target="_blank"} provides more details..
