...
- [ ] Download this [Jupyter Notebook](lab2-SSPCloud.ipynb){target="_blank"}
- [ ] Follow these [instructions](../lab-setup.qmd){target="_blank"}
- [ ] [Solution](lab2-SSPCloud-correction.qmd){target="_blank"}
...
![](img/map-end-reduce.png){.lightbox}
...
![](img/reduce-frequency.png){.lightbox}
...
![](img/vector-format.png){.lightbox}
