...
### :small_orange_diamond: 1.1 What is Big Data

* What is considered big ?
* Volume, Velocity, Variety, Veracity, Value, Variability

### :small_orange_diamond: 1.2 Computer science survival kit

* Processors, Memory, Storage, Network

### :small_orange_diamond: 1.3 High-performance computing without distribution
...
### :small_orange_diamond: 1.4 What if ?
...
### :small_orange_diamond: 1.5 Social issues

* Ethical issues, Environmental issues, Political issues

---

### :small_orange_diamond: 2.1 How to store big data

* File system, Database, Distribution 
* The CAP theorem

### :small_orange_diamond: 2.2 Hadoop file system (HDFS)

* Hadoop Ecosystem, How to use HDFS


### :small_orange_diamond: 2.3 Hadoop MapReduce

* Key Concepts

### :small_orange_diamond: 2.4 Spark
...
### :small_orange_diamond: 3 Cloud Computing
...
* [Lab 1](docs/lab/lab1/lab1-SSPCloud.ipynb) : First steps with Spark
* [Lab 2](docs/lab/lab2/lab2-SSPCloud.ipynb) : Spark ML
